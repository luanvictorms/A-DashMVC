        ...
        <main>
            ...
            <div class="insights">
                ...
                <div class="item add-product">
                    <div>
                        <button id="modal-button-cliente"><span class="material-icons-sharp">face</span></button>
                        <h3>Cadastrar Cliente</h3>
                    </div>
                </div>
                <div class="item add-product">
                    <div>
                        <button id="modal-button-novo-servico"><span class="material-icons-sharp">home_repair_service</span></button>
                        <h3>Cadastrar Novo Servico</h3>
                    </div>
                </div>
                <div class="item add-product">
                    <div>
                        <button id="modal-button-produto"><span class="material-icons-sharp">science</span></button>
                        <h3>Cadastrar Produto</h3>
                    </div>
                </div>
                <div class="item add-product">
                    <div>
                        <button id="modal-button-atendimento"><span class="material-icons-sharp">work</span></button>
                        <h3>Realizar Atendimento</h3>
                    </div>
                </div>
                <div class="item add-product">
                    <div>
                        <button id="modal-button-produto-venda"><span class="material-icons-sharp">sell</span></button>
                ...
                <div class="item add-product">
                    <div>
                        <button id="modal-button-custo"><span class="material-icons-sharp">credit_card</span></button>
                        <h3>Registrar Custo Administrativo</h3>
                    </div>
                </div>
                <div class="item add-product">
                    <div>
                        <button id="modal-button-vale"><span class="material-icons-sharp">confirmation_number</span></button>
            ...
            <div class="recent-orders">
                ...
                <table>
                    <thead>
                        <tr>
                            <th><span class="material-icons-sharp">work</span></th>
                            <th><span class="material-icons-sharp">perm_contact_calendar</span></th>
                            <th><span class="material-icons-sharp">face</span></th>
                            <th><span class="material-icons-sharp">attach_money</span></th>
                            <th><span class="material-icons-sharp">credit_score</span></th>
                            <th><span class="material-icons-sharp">calendar_month</span></th>
                            <th> </th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="recent-orders">
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="dark-table"><span class="material-icons-sharp">confirmation_number</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">psychology</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">attach_money</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">perm_contact_calendar</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">calendar_month</span></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="recent-orders">
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="dark-table"><span class="material-icons-sharp">attach_money</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">psychology</span></h>
                            <th class="dark-table"><span class="material-icons-sharp">calendar_month</span></th>
            ...
            <div class="recent-orders" id="final">
                ...
                <table>
                    <thead>
                        <tr>
                            <th class="dark-table"><span class="material-icons-sharp">perm_contact_calendar</span></th>
                            <th class="dark-table"><span class="material-icons-sharp">request_quote</span></h>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach($workerModel->workerRows as $obj): ?>
